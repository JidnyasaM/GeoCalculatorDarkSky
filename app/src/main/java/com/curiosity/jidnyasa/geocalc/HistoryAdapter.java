...
import com.curiosity.jidnyasa.geocalc.HistoryFragment.OnListFragmentInteractionListener;
                ...
                HistoryAdapter.ViewHolder, HistoryAdapter.FooterViewHolder>
{
    ...
    public HistoryAdapter(List<LocationLookup> items,
        ...
        for (LocationLookup hi : items) {
            String key = "Entries for " + hi.dateOutput;
    ...
    protected HeaderViewHolder onCreateSectionHeaderViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_section_header,
                        parent, false);
    ...
    protected void onBindItemViewHolder(final ViewHolder holder, int section, int position)
    {
        ...
        holder.mP2.setText("(" + holder.mItem.endLat + "," + holder.mItem.endLng
                + ")");
        holder.mDateTime.setText(holder.mItem.dateOutput.toString());
