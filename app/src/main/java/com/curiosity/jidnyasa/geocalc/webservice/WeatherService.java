package com.curiosity.jidnyasa.geocalc.webservice;
...
public class WeatherService extends IntentService {
    ...
    private static final String ACTION_WEATHER_AT = "com.curiosity.jidnyasa.geocalc.webservice.action.WEATHER_AT";
    private static final String BASE_URL = "https://api.darksky.net/forecast/047e042fa53d989c1bbd68763f40e388";
    public static final String BROADCAST_WEATHER = "com.curiosity.jidnyasa.geocalc.webservice.action.BROADCAST";
    // TODO: Rename parameters
    private static final String EXTRA_KEY = "com.curiosity.jidnyasa.geocalc.webservice.extra.KEY";
    private static final String EXTRA_LAT = "com.curiosity.jidnyasa.geocalc.webservice.extra.LAT";
    private static final String EXTRA_LNG = "com.curiosity.jidnyasa.geocalc.webservice.extra.LNG";
   // private static final String EXTRA_TIME = "com.curiosity.jidnyasa.geocalc.webservice.extra.TIME";
    ...
    private void fetchWeatherData(String key, String lat, String lon) {
        try {
            ...
            if (response == HttpURLConnection.HTTP_OK) {
                ...
                //Log.d(TAG,"fetchWeatherData: "+condition);
